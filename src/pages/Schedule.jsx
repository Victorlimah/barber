...
import { toDateInputValue, formatDateBR } from '../storage/helpers'
...
export default function Schedule() {
  ...
  if (submitted && submittedRequest) {
    const selectedService = services.find((s) => s.id === submittedRequest.serviceId)
    const selectedBarber = barbers.find((b) => b.id === submittedRequest.barberId)

    return (
      <div className="min-h-screen bg-zinc-900 flex flex-col">
        {/* Header */}
        <header className="bg-zinc-900 border-b border-zinc-800 px-4 py-4">
          <h1 className="text-lg font-bold text-amber-500 text-center">{barbershopName}</h1>
        </header>
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-8">
          <div className="w-full max-w-sm text-center">
            ...
            <div className="card text-left mb-6">
              <h3 className="font-semibold text-zinc-300 mb-3">Resumo do pedido</h3>
  ...
  return (
    <div className="min-h-screen bg-zinc-900 flex flex-col">
      ...
      <header className="bg-zinc-900 border-b border-zinc-800 px-4 py-4">
        <h1 className="text-lg font-bold text-amber-500 text-center">{barbershopName}</h1>
        <p className="text-zinc-500 text-sm text-center mt-1">Agendar horário</p>
      </header>
        ...
        <div className="max-w-sm mx-auto">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="card space-y-4">
              <h3 className="font-semibold text-zinc-300">Seus dados</h3>
              <div>
            ...
            {/* Date/Time */}
            <div className="card space-y-4">
              <h3 className="font-semibold text-zinc-300">Quando você quer vir?</h3>
            ...
            {/* Service & Barber */}
            <div className="card space-y-4">
              <h3 className="font-semibold text-zinc-300">Preferências (opcional)</h3>
